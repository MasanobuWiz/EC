    ...
    <div class="card is-clearfix columns">
      ...
      <div class="card-content column is-two-thirds">
        ...
        <div class="card-content__text">
          <p>
            ãµã³ãã«ã§ããã¢ãã¯ã§ããååã®ç´¹ä»æãããã¾ãï¼ï¼ï¼ä¸è¦§ç»é¢ã®ååç´¹ä»ãããè©³ããèª¬æãã¼ã¿ãä½ã£ã¦ããã«å·®ãè¾¼ã¿ã¾ãã
          </p>
        </div>
...
export default {
  ...
  data() {
    return {
      addToCartLabel: 'ã«ã¼ãã«å¥ãã',
      removeFromCartLabel: 'ã«ã¼ãããåãåºã',
      addToFavouriteLabel: 'ãæ°ã«å¥ãã«ç»é²',
      removeFromFavouriteLabel: 'ãæ°ã«å¥ãããå¤ã',
      product: {},
      selected: 1,
      quantityArray: []
    }
